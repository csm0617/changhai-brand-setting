...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const ZH = {
			...
			"browser.hint": "留空则使用内置的长海图标；标签页标题留空则保持官方不变。",
			"footer.hint":
		...
		const EN = {
			...
			"browser.hint": "Left empty, the tab icon falls back to the built-in Changhai mark; the tab title stays as shipped while its field is empty.",
			"footer.hint":
